/* OhigginsPermisoEntityDaoHibernateImplTest.java
 * 
 * Copyright (C) 2012
 * 
 ...
 * 
 */
public class OhigginsPermissionEntityDaoHibernateImplTest extends
		ApplicationContextAwareTest {

	@Resource
	private OhigginsPermissionEntityDao ohigginsPermissionEntityDao;
	...
	public final void testFindById() {
		...
		newPermission.setId(10000L);
		ohigginsPermissionEntityDao.makePersistent(newPermission);
		PermissionEntity e = ohigginsPermissionEntityDao.findById(
				Long.valueOf(10000), false);
		assertNotNull(e);
		assertEquals("El ID del permiso es incorrecto", Long.valueOf(10000),
				e.getId());
	}
