...
/**
 * Simple acces to files. Used by {@link SectionExporterDAOReadSQLFilesImpl}
 * 
...
public class SQLFileutils {
	 ...
	 * 
	 * @param sqlFile
	 *            with the paameter name
	 * 
	 * @return right side from sqlFile splited by '_' and deleted last 4
	 *         characters
	 */
	public static String getParameterName(String sqlFile) {
		String subFileName = sqlFile.split("_")[1];
		String subFileName2 = subFileName
				.substring(0, subFileName.length() - 4);
		return subFileName2;
	}
	...
	/**
	 * Auxiliary methods and properties copies from
