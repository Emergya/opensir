/*
 * OhigginsLayerTypeEntityDao.java
 * 
 * Copyright (C) 2012
 * 
 ...
 * 
 */
public interface OhigginsLayerTypeEntityDao extends
		GenericDAO<LayerTypeEntity, Long> {

	/**
	 * Obtiene un tipo de la capa por nombre del tipo de la capa
	 * 
	 * @param layerTypeName
	 * 
