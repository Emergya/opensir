/*
 * OhigginsLayerMetadataTmpEntityDao.java
 * 
 * Copyright (C) 2012
 * 
...
/**
 * Dao para layer Metadata tmp
 * 
 * @author <a href="mailto:jariera@emergya.com">jariera</a>
 * 
 */
public interface OhigginsLayerMetadataTmpEntityDao extends
		GenericDAO<LayerMetadataTmpEntity, Long> {
	/**
