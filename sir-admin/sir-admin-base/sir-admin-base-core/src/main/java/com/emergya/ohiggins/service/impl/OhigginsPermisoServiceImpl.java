...
/**
 * Implementacion transacional de PersimoService basada en el uso de DAOs
...
@Repository
@Transactional
public class OhigginsPermisoServiceImpl extends
		AbstractServiceImpl<PermisoDto, PermissionEntity> implements
		PermisoService {
	 ...
	 * Constructor
	 */
	public OhigginsPermisoServiceImpl() {
		super();
	}

	@Override
	protected PermisoDto entityToDto(PermissionEntity entity) {
		PermisoDto dto = null;
	...
	@Override
	protected PermissionEntity dtoToEntity(PermisoDto dto) {
	...
	@Override
	protected GenericDAO<PermissionEntity, Long> getDao() {
		return permisoDao;
	}
	...
	public PermisoDto getById(Long id) {
		return entityToDto(permisoDao.findById(id, false));
	}
