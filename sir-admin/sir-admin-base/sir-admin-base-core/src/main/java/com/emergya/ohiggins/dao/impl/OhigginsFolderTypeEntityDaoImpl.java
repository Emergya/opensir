/*
 * OhigginsFolderTypeEntityDaoImpl.java
 * 
 * Copyright (C) 2012
 * 
...
/**
 * Implementacion Dao para folder type
 * 
 * @author marcos
 * 
 */
@Repository
public class OhigginsFolderTypeEntityDaoImpl extends GenericHibernateDAOImpl<FolderTypeEntity, Long> 
implements OhigginsFolderTypeEntityDao{
