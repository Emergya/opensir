...
public class LayerPropertyEntity extends AbstractLayerPropertyEntity {
	...
	@Id
	@Column(name = "id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "gis_layer_property_seq")
	@SequenceGenerator(name = "gis_layer_property_seq", sequenceName = "gis_layer_property_seq", initialValue = 1000, allocationSize = 20)
	public Long getId() {
		return this.id;
	}
