 ...
 * Copyright (C) 2013
 *
 * This file is part of ohiggins project
 *
...
public class SourceToolEntity extends AbstractSourceToolEntity {
	...
	@Id
    @Column(name = "id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "gis_source_id_seq")
    @SequenceGenerator(name="gis_source_id_seq", sequenceName = "gis_source_id_seq", 
    				initialValue=100)
	public Long getId() {
		return id;
	}
