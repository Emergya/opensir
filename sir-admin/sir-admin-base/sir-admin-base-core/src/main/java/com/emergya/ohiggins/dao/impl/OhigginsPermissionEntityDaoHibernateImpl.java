...
/**
 * Implementacion de Permiso dao para hibernate
 * 
 * @author <a href="mailto:jariera@emergya.com">jariera</a>
 * 
 */
@Repository
public class OhigginsPermissionEntityDaoHibernateImpl extends
		GenericHibernateDAOImpl<PermissionEntity, Long> implements
		OhigginsPermissionEntityDao {
