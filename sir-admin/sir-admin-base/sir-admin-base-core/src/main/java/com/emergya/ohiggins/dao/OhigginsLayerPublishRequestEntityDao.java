/*
 * OhigginsLayerPublishRequestDao.java
 * 
 * Copyright (C) 2012
 * 
...
/**
 * Dao para Capa de publicacion
 * 
 * @author <a href="mailto:jariera@emergya.com">jariera</a>
 * 
 */
public interface OhigginsLayerPublishRequestEntityDao extends
		GenericDAO<LayerPublishRequestEntity, Long> {
	...
	/**
	 * Gets a layer publication request by its geoserver name.
	 * @param geoserverName
	 * @return
	 */
	public LayerPublishRequestEntity getByTmpLayerName(String geoserverName);

    public List<LayerPublishRequestEntity> getByUser(UserEntity dtoToEntity);
