...
/**
 * Implementacion de Region dao para hibernate
 * 
 * @author <a href="mailto:jariera@emergya.com">jariera</a>
 * 
 */
@Repository
public class OhigginsRegionEntityDaoHibernateImpl extends
		GenericHibernateDAOImpl<RegionEntity, Long> implements
		OhigginsRegionEntityDao {
