 ...
 *         Ponce</a>
 */
public class ChileindicaInversionDataDto implements Serializable {

	private static final long serialVersionUID = 6855326680433201277L;
	private Long id;
	...
	private List<ChileindicaInversionFinanciamientoDataDto> financiamientosList;
	private List<ChileindicaRelacionIntrumentosDataDto> relacionInstrumentosList;

	public ChileindicaInversionDataDto() {
		financiamientosList = new ArrayList<ChileindicaInversionFinanciamientoDataDto>();
		relacionInstrumentosList = new ArrayList<ChileindicaRelacionIntrumentosDataDto>();
	}

	public ChileindicaInversionDataDto(Long id) {
		this.id = id;
	}
	...
	public List<ChileindicaInversionFinanciamientoDataDto> getFinanciamientosList() {
		return this.financiamientosList;
	}

	public void setFinanciamientosList(
			List<ChileindicaInversionFinanciamientoDataDto> chileindicaInversionFinanciamientoDataEntityList) {
		this.financiamientosList = chileindicaInversionFinanciamientoDataEntityList;
	}

	public List<ChileindicaRelacionIntrumentosDataDto> getRelacionInstrumentosList() {
		return relacionInstrumentosList;
	}

	public void setRelacionInstrumentosList(
			List<ChileindicaRelacionIntrumentosDataDto> chileindicaRelacionIntrumentosDataEntityList) {
	...
	public boolean equals(Object object) {
		...
		// not set
		if (!(object instanceof ChileindicaInversionDataDto)) {
			return false;
		}
		ChileindicaInversionDataDto other = (ChileindicaInversionDataDto) object;
	...
	public String toString() {
		return "ChileindicaInversionDataDto[ id=" + id + " ]";
	}
