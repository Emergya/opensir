/*
 * ChileindicaInversionDataDao.java
 * 
 * Copyright (C) 2013
 * 
 ...
 *         Ponce</a>
 */
public interface ChileindicaInversionDataDao extends
		GenericDAO<ChileindicaInversionDataEntity, Long> {

	/**
	 * 
	 * @return all the existing IDs in the database.
	 */
	List<Long> getAllIds();
