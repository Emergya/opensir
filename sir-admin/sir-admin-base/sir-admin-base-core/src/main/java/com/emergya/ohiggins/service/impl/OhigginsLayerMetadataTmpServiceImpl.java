/*
 * LayerMetadataTmpServiceImpl.java
 * 
 * Copyright (C) 2012
 * 
...
import com.emergya.ohiggins.service.LayerMetadataTmpService;
import com.emergya.persistenceGeo.dao.GenericDAO;
import com.emergya.persistenceGeo.service.impl.AbstractServiceImpl;

/**
 * Implementacion Servicio para el manejo de LayerMetadataTmp
 * 
 * @author jariera
 * 
 */
@Repository
@Transactional
public class OhigginsLayerMetadataTmpServiceImpl extends
		AbstractServiceImpl<LayerMetadataTmpDto, LayerMetadataTmpEntity>
		implements LayerMetadataTmpService {
	...
	@Resource
	private OhigginsLayerMetadataTmpEntityDao ohigginsLayerMetadataTmpDao;

	@Override
	protected GenericDAO<LayerMetadataTmpEntity, Long> getDao() {
		return ohigginsLayerMetadataTmpDao;
	}
	 ...
	 * @return
	 */
	public LayerMetadataTmpDto getMetadataTmpByIdLayer(Long idLayer) {
		LayerMetadataTmpDto dtor = null;
		LayerMetadataTmpEntity entity = ohigginsLayerMetadataTmpDao
				.getMetadataTmpByIdLayer(idLayer);
