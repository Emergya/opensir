 ...
 * 
 */
public interface InversionUpdateService extends AbstractService {

	/**
	 * Establece el campo <code>enabled</code> de la entidad a true y todas las
	 * demás del mismo tipo a <code>false</code>.
	 * 
	 * @param inversionDto
	 */
