 ...
 * 
 */
public interface OhigginsFaqEntityDao extends GenericDAO<FaqEntity, Long> {
	...
	/**
	 * Obtiene una lista de faqs ordenados por una propiedad.
	 * 
	 * @param first
	 * @param last
	 * @param propertyName
	...
	/**
	 * Obtiene una lista de faqs del modulo especificado.
	 * 
	 * @param module
	 * @return
	 */
