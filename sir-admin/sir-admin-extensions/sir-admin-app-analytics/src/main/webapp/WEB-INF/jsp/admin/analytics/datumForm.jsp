...
<html>
    <head>
        ...
        <spring:url  var="saveDatumUrl" value="/admin/analitico/guardarDato"/>
        ...
        <title>
            <c:choose>
                <c:when test="${empty analyticsDataDto.identifier}">
                    Nuevo Dato
                </c:when>
                <c:otherwise>
                    Actualizar Dato
        ...
        <form:form action="${saveDatumUrl}" commandName="datumDto" method="post"
            ...
            <div class="span-22 last">
                <div class="span-11">
                    ...
                    <c:if test="${empty analyticsDataDto.identifier}">
                        <div class="span-11 last">
                            <html:inputField name="file" label="Archivo"
                                             type="file"                                           
                                             lblCtrCssClass="span-3"
                                             ctrCssClass="span-8 last"
                                             cssClass="campo" cssErrorClass="campoError"
