...
/**
 * The interface for a dao class that handles the analytics module's categories.
 * @author lroman
 *
 */
public interface AnalyticsCategoryDao 
	extends GenericDAO<AnalyticsCategoryEntity, Long>{
