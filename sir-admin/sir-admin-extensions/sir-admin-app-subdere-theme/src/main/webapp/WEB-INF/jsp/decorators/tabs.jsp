			...
			<c:when test='${IS_ADMIN}'>
				<ul class="tabs parentTabs">
					...
					<li id="repositorioEstudios"
						class='${module eq "repositorio" ? "active" :"" }'><a
						href="${adminRepositorioUrl}/pendientes"><span>Repositorio de
							estudios</span></a></li>							
					<li id="repositorioEstudios"
						class='ultimoDerecha ${module eq "analitico" ? "active" :"" }'><a
						href="${analyticsUrl}/solicitudesPublicacion"><span>Módulo  Análisis-Estadístico</span></a></li>
				</ul>
			</c:when>
			<c:otherwise>
				<ul class="tabs parentTabs">
					...
					<li id="repositorioEstudios"
						class='ultimoDerecha ${module eq "analitico" ? "active" :"" }'><a
						href="${analyticsUrl}/datos"><span>Módulo  Análisis-Estadístico</span></a></li>
				</ul>
			</c:otherwise>
		</c:choose>
	</c:when>
