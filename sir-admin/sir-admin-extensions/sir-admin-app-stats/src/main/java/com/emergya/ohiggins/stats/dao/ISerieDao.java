...
public interface ISerieDao {
	...
	public static final String NB_VISITS_KEY = "nb_visits";
	public static final String NB_UNIQ_VISITORS_KEY = "nb_uniq_visitors";
	...
	/**
	 * Returns a serie for a fixed period.
	 * 
	 * @return SerieDto
	 */
