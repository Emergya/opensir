...
if ($xsoloconsulta!=1) {
		/****DIV 2 cuando se esta ingresando desde cero la ficha****/
		$ventana .=	"<div class='dvUTerritorialLeft'>";
		$ventana .=	"<span><div class='titulo_medio'><p>(*) Area de Influencia</p></div></span></br>";
		if ($xinfluencia==1) {$sel='checked';} else {$sel='';}
		...
		/****DIV 4****/
		$ventana .=	"<div class='dvUTerritorialLeft'>";
		$ventana .=		"<span><div class='titulo_medio'><p>Georeferenciaci&oacute;n (x,y)</p></div></span>";
		...
		$ventana .= 	"<textarea id=\"coordenadas\" name=\"coordenadas\" class=\"area_texto\" disabled=\"disabled\"></textarea><br>";		
		$ventana .=	"</div>";
...
class I_Mensaje {
   ...
   function crear_interface() {
      $ventana  = "	<div id=\"carga\">";
      $ventana .= "		<table>";
      $ventana .= "     	<tr>";
      $ventana .= "         	<td valign=\"middle\" class=\"td1 textomensaje\"><img src=\"../../imagenes/cargando.gif\" width=\"32px\" height=\"32px\" alt=\"cargando\"/></td>";
      $ventana .= "             <td valign=\"middle\" class=\"td2 tabla\" id=\"textomensaje\" ><strong>MENSAJE</strong></td>";
      $ventana .= "			</tr>";
      $ventana .= "		</table>";
      $ventana .= "</div>";
      return $ventana;
